 ...
 */
function aviToMp4LoadVideo(videoDetail: any, videoUrl: string, isMpegFormat: { value: boolean }): void {
    aviToMp4(videoDetail, videoUrl, isMpegFormat, ffmpegService, playerInstance);
}
